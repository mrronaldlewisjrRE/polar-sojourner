...
export default function Calendar() {
    ...
    const selectedDateEvents = (Array.isArray(events) ? events : []).filter(e => e?.date === selectedDate);
    ...
    const sortedAllEvents = [...(Array.isArray(events) ? events : [])].sort((a, b) => {
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                    ...
                    <div className="divide-y divide-gray-100 dark:divide-gray-700">
                        {sortedAllEvents.length === 0 ? (
                            ...
                            (Array.isArray(sortedAllEvents) ? sortedAllEvents : []).map(event => (
                                <div
                                    key={event.id}
                        ...
                        {modalView === 'list' ? (
                            <div className="space-y-4 overflow-y-auto flex-1">
                                ...
                                {sortedSelectedDateEvents.length === 0 ? (
                                    ...
                                    (Array.isArray(sortedSelectedDateEvents) ? sortedSelectedDateEvents : []).map(event => (
