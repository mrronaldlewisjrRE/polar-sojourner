...
export const generateConfirmationPdf = (order, retailer, vendor, distributor, poNumber, evidenceFiles) => {
    ...
    doc.text("CDH Associates | 8816 College Grove, TN 37046", 30, y);
    y += 5;
    doc.text("+1(423) 894-9417 | Fax (615) 368-3381 | csr@CDHAssociates.com", 30, y);

    // Footer
    doc.setFontSize(8);
    doc.setTextColor(150, 150, 150);
    doc.text("Generated by CDH Order Intake Platform v5A.0", pageWidth / 2, pageWidth + 60, { align: 'center' }); // Bottom center
